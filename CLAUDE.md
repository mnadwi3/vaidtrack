...
**WhatsApp CTA number actually in use:** `919818377518` (updated 2026-09-09; README and llms.txt now match, see §11).
...
- (Resolved 2026-08-30, superseded 2026-09-01, superseded again 2026-09-09)
  `README.md`'s WhatsApp CTA number previously read `wa.me/918979983149`, out
  of sync with the number actually used across live pages. It was changed
  sitewide on 2026-09-01 to `919871262293` (from the interim `919818377518`),
  then changed back sitewide on 2026-09-09 to `919818377518` (the site's
  official number per the user); README and llms.txt were updated to match
  each time.
